                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $page_data['orders_count']?></div>
                                    <div>Заказы</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $page_data['products_count']?></div>
                                    <div>Товары</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $page_data['users_count']?></div>
                                ...
                                <div class="col-lg-4">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                                foreach($page_data['orders'] as $id => $order_arr) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $id?></td>
                                                    <td><?php echo $order_arr['amount']?></td>
                                                    <td><?php echo $order_arr['user_name']?></td>
                                                    <td><?php echo $order_arr['email']?></td>
                                                </tr>
                                            <?php
                                                }
                                            ?>
